...
def init_args():
    parser = argparse.ArgumentParser(description='Bundled PaddleOCR RKNN runtime')
    # basic params
    parser.add_argument('--det_model_path', type=str, required=True, help='RKNN detector model path')
    parser.add_argument('--rec_model_path', type=str, required=True, help='RKNN recognizer model path')
    parser.add_argument('--target', type=str, default='rk3588', help='target RKNPU platform')
    parser.add_argument('--device_id', type=str, default=None, help='device id')
    parser.add_argument('--core_mask', type=str, default='NPU_CORE_1', help='RKNNLite NPU core mask')
